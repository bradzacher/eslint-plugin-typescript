...
| [`typescript/interface-over-type-literal`](./docs/rules/interface-over-type-literal.md) | Prefer an interface declaration over a type literal (type T = { ... }) (`interface-over-type-literal` from TSLint) |  | :wrench: |
