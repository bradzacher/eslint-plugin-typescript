...
const rules = {
    "typescript/typescript-uses-vars": "error"
};
...
ruleTester.run("no-unused-vars", ruleNoUnusedVars, {
    ...
    valid: [
        ...
        {
            code: [
                "import { IRender } from 'test-interfaces'",
                "let render: IRender",
                "render()"
            ].join("\n"),
            parser,
    ...
    invalid: [
        ...
        },
        {
            ...
            rules,
            errors: [{
                message: "'IRender' is defined but never used",
                line: 1,
                column: 10
            }]
        },
        /**
         * This test will fail until https://github.com/eslint/typescript-eslint-parser/pull/83 is merged
         */
        // {
        //     code: [
        //         "type IRender = Function",
