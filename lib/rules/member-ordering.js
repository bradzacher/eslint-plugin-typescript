...
var schemaOptions = ["field", "method", "constructor"].reduce(function(options, type) {
    options.push(type);

    ["public", "protected", "private"].forEach(function(accessibility) {
        options.push(accessibility + "-" + type);
        if (type !== "constructor") {
            ["static", "instance"].forEach(function(scope) {
...
module.exports = {
    ...
    create: function(context) {
        ...
        function getRank(node, order, supportsModifiers) {
            ...
            var scope = node.static ? "static" : "instance";
            var accessibility = node.accessibility || "public";
        ...
        function validateMembers(members, order, supportsModifiers) {
            if (members && order !== "never") {
                ...
                members.forEach(function(member) {
                    var rank = getRank(member, order, supportsModifiers);
                    if (rank !== -1) {
        ...
        return {
            ...
            TSInterfaceDeclaration: function(node) {
                validateMembers(node.members, options.interfaces || options.default || defaultOrder, false);
            },
